...
namespace FudeeTestApi.Controllers
{
    public class OpinionsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id)
        {
            ...
            {
                var appDbContext = _context.Opinions.Include(o => o.Restaurant).Include(o => o.User).Where(o => o.RestaurantId == id);
        ...
        public IActionResult Create(int? id)
        {
            ...
            Models.Restaurant restaurant = _context.Restaurants.Find(id);
            if (restaurant == null)
            {
                return BadRequest();
            }
        ...
        public async Task<IActionResult> Create([Bind("OpinionId,Comment,Rating,RestaurantId")] Opinion opinion)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", "Restaurants", new { id = opinion.RestaurantId }, "comments");
            }
            ViewData["RestaurantId"] = opinion.RestaurantId;
            ViewData["RestaurantName"] = opinion.Restaurant.RestaurantName;
            return View(opinion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> CreatePartial([Bind("OpinionId,Comment,Rating,RestaurantId")] Opinion opinion)
        {
            if (ModelState.IsValid)
            {
                opinion.AddedDate = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OpinionId,Comment,AddedDate,Rating,RestaurantId,Id")] Opinion opinion)
        {
